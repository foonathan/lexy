...
Parse tree::
  Single token node with the {{% docref "lexy::predefined_token_kind" %}} `lexy::newline_token_kind`.
...
Parse tree::
  Single token node with the {{% docref "lexy::predefined_token_kind" %}} `lexy::eol_token_kind`.
