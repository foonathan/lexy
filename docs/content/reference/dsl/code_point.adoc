...
namespace lexy::dsl
{
    ...
    public:
        ...
        consteval _token-rule_ auto if_() const; // see below
    };
...
{{% playground_example code_point "Parse one code point in the inputs encoding" %}}
...
consteval _token-rule_ auto if_() const;
----
...
{{% playground_example code_point_if "Parse even code points only" %}}
