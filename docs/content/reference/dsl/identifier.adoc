...
namespace lexy::dsl
{
    ...
    {
        //=== modifiers ===//
        consteval _identifier-dsl_ reserve(_rule_ auto ... rules) const;
        consteval _identifier-dsl_ reserve_prefix(_rule_ auto ... rules) const;
        consteval _identifier-dsl_ reserve_containing(_rule_ auto ... rules) const;

        //=== sub-rules ===//
        consteval _token-rule_ auto pattern() const;

        consteval _token-rule_ auto leading_pattern() const;
        consteval _token-rule_ auto trailing_pattern() const;
    };

    consteval _identifier-dsl_ identifier(_token-rule_ auto leading,
                                        _token-rule_ auto trailing);

    consteval _identifier-dsl_ identifier(_token-rule_ auto pattern)
    {
...
{{% interface %}}
----
consteval _identifier-dsl_ reserve(_rule_ auto ... rules) const; <1>
consteval _identifier-dsl_ reserve_prefix(_rule_ auto ... rules) const; <2>
consteval _identifier-dsl_ reserve_containing(_rule_ auto ... rules) const; <3>
----
...
{
    template <auto Str>
    consteval _token-rule_ auto keyword(_identifier-dsl_ identifier);
}
