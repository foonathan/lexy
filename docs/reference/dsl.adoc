...
n_digits<N, Base>.no_leading_zero() : Pattern
----
...
[godbolt,cpp,id=o4Y7Eq]
----
// Matches 4 upper-case hexadecimal digits seperated by ' without leading zeroes.
dsl::n_digits<4, dsl::hex_upper>.sep(dsl::digit_sep_tick).no_leading_zero()
----
