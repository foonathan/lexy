...
Minimal `CMakeLists.txt` files using lexy with https://cmake.org/cmake/help/latest/module/FetchContent.html[FetchContent] or https://github.com/cpm-cmake/CPM.cmake[CPM.cmake] can be found under https://github.com/foonathan/lexy/tree/main/examples/project-templates[examples/project-templates].
