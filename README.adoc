...
Unicode support::
  You can parse UTF-8, UTF-16, or UTF-32 and access (some of) the Unicode character database.
  ...
  Want to match any Unicode alphabetic or whitespace character, or a Unicode-aware identifier?
