...
TEST_CASE("make_error_location")
{
    ...
    SUBCASE("basic")
    {
        ...
        CHECK(first_1.context.string_view() == "Line 1");
        ...
        CHECK(out_of_bounds.context.string_view().empty());
    }
    SUBCASE("no trailing newline")
    {
        ...
        CHECK(end.line == 3);
        CHECK(end.column == 7);
        CHECK(end.context.string_view() == "Line 3");
    }
